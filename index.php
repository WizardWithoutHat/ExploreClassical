				...
				<div class="col-sm-4"> 
					<div class="container-fluid">	
						<div class="page-header text-center">
							<h1 class="text-important">Go Exploreing!</h1>
						</div>
						
						<p> This website offers you access into the world of one of the greatest genres of music in the history of man, Classical Music. 
