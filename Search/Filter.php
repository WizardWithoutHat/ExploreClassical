...
$Artistname = $_REQUEST["search_artistname"];
?>
	...
	<body>
			...
			<div class="container-fluid">
				...
				<div>
					<ul class="nav navbar-nav">
						<li class="active"> <a href="http://explore-classical.com/index.php"> Home </a> </li>
		...
		<div class="jumbotron">
			<h1 class="text-primary" style="padding-left:5%;"> 
				<?php 
					$recordset = mysqli_query($conn, "SELECT Artist_Name FROM Music WHERE Artist_Name LIKE '%".$Artistname."%' ");
		...
		<div class="container-fluid">		
			<div class="row">
				<div class="col-sm-4"> 
					...
					<?php
							$recordset = mysqli_query($conn, "SELECT Description FROM Music WHERE Artist_Name LIKE '%".$Artistname."%' ");
							$result = $recordset->fetch_assoc();
				...
				<div class="col-sm-8">
					<div class="page-header text-center">
						<h1 class="text-important"><?php
								$recordset = mysqli_query($conn, "SELECT Track_Name FROM Music WHERE Artist_Name LIKE '%".$Artistname."%' ");
								$result = $recordset->fetch_assoc();
					...
					<center>
						<iframe id="randomMusic" src="
							<?php
								$recordset = mysqli_query($conn, "SELECT spotifyURL FROM Music WHERE Artist_Name LIKE '%".$Artistname."%' ");	
								$result = $recordset->fetch_assoc();
