...
Latest File Update: 2015-Feb-06
*/
...
$aff+=updateArray(array('topic_last_poster'), $Tt, 'topic_last_poster', $uname);
}

$aff+=updateArray($updPosts, $Tp, 'poster_id', $user);
$aff+=updateArray($updTopics, $Tt, 'topic_poster', $user);
