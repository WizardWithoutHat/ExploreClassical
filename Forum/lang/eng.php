...
$l_delSendMais='Type an email address to delete, or press a button for clearing up the whole table.<br /><strong>Attention: you will be not asked twice!</strong>';
$l_delete='Delete';
...
/* Who's online language */

$l_whosOnline='Online now: ';
$l_guestsOnline='Guests';
$l_loggedOnline='Members';
$l_onlineRecord='Most users ever online:';
$l_onlineHidden='hidden';
$l_onlineShowStatus='Show my online status to others';
$l_onlineNow='Online now!';
$l_onlineNo='Offline now';

$l_membersList='Members List';/* Avatars language */
$l_usrInfo[12]='Avatar';
...
/* Preview language */
$l_preview='Preview';
$l_previewClose='Close';
$l_previewFiles='<strong>Note</strong>: uploaded files will be shown at the end of your message only after the message has been posted.';
