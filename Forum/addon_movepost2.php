...
Latest File Update: 2014-Oct-22
*/
...
if($smd>0){
echo "<script type=\"text/javascript\">var loc = window.opener.location; window.opener.location = loc;</script>";
}
...
{$whatToMove}
<br />
<span class="txtNr"><input type="text" name="topicid" size="6" maxlength="10" class="textForm" /><br />{$l_topicId}<br /></span>
<br />
