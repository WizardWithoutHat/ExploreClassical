<?php
/*
addon_preview.php: preview addon script for miniBB.
This file is part of miniBB. miniBB is free discussion forums/message board software, without any warranty.
See COPYING file for more details. Copyright (C) 2004-2008, 2012, 2014 Paul Puzyrev. www.minibb.com
Latest File Update: 2014-Mar-18
*/
if (!defined('INCLUDED776')) die ('Fatal error.');

if($_POST['action']=='pmail') $post_text_minlength=1;

if(isset($_POST['prevForm']) and (integer)$_POST['prevForm']+0==1 and strlen(trim($_POST['postText']))>=$post_text_minlength){
...
elseif(isset($_POST['prevForm']) and (integer)$_POST['prevForm']+0==1 and strlen(trim($_POST['postText']))<$post_text_minlength){
echo '';
exit;
}
